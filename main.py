...
# Tworzenie pacjenta i lekarza
patient = Patient(age=50, gender="male", disease={"name": "heart_attack", "details": DISEASES["heart_attack"]})
doctor = Doctor(specialization="Cardiology", worktime=8)

# Diagnoza pacjenta
doctor.diagnose_patient(patient, DISEASES)

# Wyświetlenie wyników
print(f"Oryginalna choroba: {patient.disease['name']}")
print(f"Zdiagnozowana choroba: {patient.diagnosis_result['name']}")
print(f"Czas diagnozy: {patient.diagnosis_time} minut")
print(f"Czas operacji: {patient.diagnosis_result['details'].get('operation_time', 'Brak operacji')} minut")
print(f"Czas hospitalizacji: {patient.diagnosis_result['details']['hospitalization_time']} minut")
